...
class PerencanaanDanaModel {
    ...
    static async insertTabungan(data) {
        try {
            ...
            // console.log(data.tahun, data.bulan, parseFloat(data.nominal_tabungan_masuk), parseFloat(saldo_kumulatif));return;
    ...
    static async delteTabungan(data) {
        try {
            ...
            let result_saldo_kumulatif = await db.query(query_get_saldo_kumulatif, [data.nama_anggota]);
            let saldo_kumulatif = result_saldo_kumulatif.rows[0].saldo_kumulatif;
            saldo_kumulatif = parseInt(saldo_kumulatif) - parseInt(nominal_tabungan_masuk);
